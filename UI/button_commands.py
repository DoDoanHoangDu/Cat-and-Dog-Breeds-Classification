...
FOLDER_CATS = os.path.join(dir_path, "Data\\CatBreeds\\test")
FOLDER_DOGS = os.path.join(dir_path, "Data\\DogBreeds\\test")
...
def identify_breed(image_paths,models,device,grid_frame):
